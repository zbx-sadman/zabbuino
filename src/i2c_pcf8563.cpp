...
*****************************************************************************************************************************/
/*
uint8_t isPCF8563Running(SoftwareTWI* _softTWI, const uint8_t _i2cAddress) {
  uint8_t creg;
...
*****************************************************************************************************************************/
/*
void setPCF8563RunningState(SoftwareTWI* _softTWI, const uint8_t _i2cAddress, uint8_t _isRunning) {
  uint8_t creg;
...
*
*****************************************************************************************************************************/
static uint8_t isPCF8563DateTimeValid(SoftwareTWI* _softTWI, const uint8_t _i2cAddress) {
  uint8_t vlSeconds;
...
*
*****************************************************************************************************************************/
int8_t initPCF8563(SoftwareTWI* _softTWI, const uint8_t _i2cAddress) {
...
*
*****************************************************************************************************************************/
int8_t savePCF8563Time(SoftwareTWI* _softTWI, uint8_t _i2cAddress, time_t _y2Ktimestamp) {
  int8_t rc = RESULT_IS_FAIL;
...
*
*****************************************************************************************************************************/
int8_t readPCF8563Time(SoftwareTWI* _softTWI, uint8_t _i2cAddress, time_t* _timestamp) {
  int8_t rc = RESULT_IS_FAIL;
  uint8_t centuryFlag;
  uint8_t rawData[PCF8563_REG_TIMEDATE_SIZE];
  tm dateTime;
