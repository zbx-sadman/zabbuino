...
*
*****************************************************************************************************************************/
int8_t getTSL2561Metric(SoftwareTWI* _softTWI, uint8_t _i2cAddress, const uint16_t _integrationTime, const uint8_t _gain, const uint8_t _metric, int32_t* _value){
