...
int8_t getPlantowerWuhanPMOneMetric(SoftwareTWI*, uint8_t, uint8_t, const uint8_t, const uint8_t, uint32_t*);
int8_t getPlantowerWuhanPMAllMetrics(SoftwareTWI*, uint8_t, char*, const uint16_t);
