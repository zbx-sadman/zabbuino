...
*
*****************************************************************************************************************************/
static uint8_t isDS3231Running(SoftwareTWI* _softTWI, const uint8_t _i2cAddress) {
...
*
*****************************************************************************************************************************/
static void setDS3231RunningState(SoftwareTWI* _softTWI, const uint8_t _i2cAddress, uint8_t _isRunning) {
...
*
*****************************************************************************************************************************/
int8_t initDS3231(SoftwareTWI* _softTWI, const uint8_t _i2cAddress) {
...
*
*****************************************************************************************************************************/
int8_t saveDS3231Time(SoftwareTWI* _softTWI, uint8_t _i2cAddress, time_t _y2Ktimestamp) {
  int8_t rc = RESULT_IS_FAIL;
...
*
*****************************************************************************************************************************/
int8_t readDS3231Time(SoftwareTWI* _softTWI, uint8_t _i2cAddress, time_t* _timestamp) {
  int8_t rc = RESULT_IS_FAIL;
  uint8_t rawData[DS3231_REG_TIMEDATE_SIZE];
  uint8_t centuryFlag;
  tm dateTime;
