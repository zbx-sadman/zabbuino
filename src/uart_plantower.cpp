...
static int8_t getRawDataViaI2C(SoftwareWire*, uint8_t, uint8_t*, const uint8_t);
...
static int8_t getPlantowerWuhanPMMetricViaI2C(SoftwareWire*, uint8_t, uint8_t, const uint8_t, const uint8_t, char*, const uint16_t, uint32_t*);
...
int8_t getPlantowerWuhanPMOneMetric(SoftwareWire* _softTWI, uint8_t _i2cAddress, uint8_t _metric, const uint8_t _concentrationType, const uint8_t _particlesSize, uint32_t* _value) {
  char stubBuffer;
...
int8_t getPlantowerWuhanPMAllMetrics(SoftwareWire* _softTWI, uint8_t _i2cAddress, char* _dst, const uint16_t _dstSize) {
  uint32_t stubValue;
...
static int8_t getPlantowerWuhanPMMetricViaI2C(SoftwareWire* _softTWI, uint8_t _i2cAddress, uint8_t _metric, const uint8_t _concentrationType, const uint8_t _particlesSize, char* _dst, const uint16_t _dstSize, uint32_t* _value) {
  int8_t rc = DEVICE_ERROR_TIMEOUT;
...
static int8_t getRawDataViaI2C(SoftwareWire* _softTWI, uint8_t _i2cAddress, uint8_t* _buffer, const uint8_t _bufferSize) {
